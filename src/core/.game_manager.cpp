...
// 	Entity* GameManager::instantiate_entity()
// 	{
// 		Entity* entity = new Entity();

// 		entity->body_type = BodyType::NONE;
// 		entity->manager = this;
...
// 	Entity* GameManager::copy_entity(Entity* entity, bool add_to_state)
// 	{
// 		Entity* new_entity = new Entity(*entity);

// 		if (add_to_state)
// 		{
// 			this->m_objects.push_back(new_entity);
// 			this->m_entities.push_back(new_entity);
// 			this->m_renderer->add_to_layer(new_entity, new_entity->layer);
// 		}
