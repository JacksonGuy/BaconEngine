...
Renderer::Renderer(uint32_t width, uint32_t height)
{
    ...
    {
        this->m_layers[i] = (RenderLayer){i, true, std::vector<GameObject*>()};
    }
}
...
uint32_t Renderer::get_width() const { return this->m_frame_width; }

uint32_t Renderer::get_height() const { return this->m_frame_height; }
} // namespace bacon
